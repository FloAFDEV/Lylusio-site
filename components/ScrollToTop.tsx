...
const ScrollToTop = () => {
  ...
  return (
    <button
      onClick={scrollToTop}
      className={`fixed bottom-6 right-6 z-50 w-12 h-12 rounded-full border-2 border-border/40 bg-background/60 backdrop-blur-md hover:bg-background/80 hover:border-accent/50 text-foreground shadow-soft hover:shadow-medium flex items-center justify-center transition-all duration-500 hover:scale-110 ${
