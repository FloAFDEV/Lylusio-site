	...
	return (
		...
		>
			...
			<div className="border-b border-primary-foreground/20 relative overflow-hidden">
				...
				<div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[700px] h-[350px] bg-gold/15 rounded-full blur-[140px] opacity-60" aria-hidden="true" />
				...
				<div className="container mx-auto px-5 md:px-8 lg:px-10 py-12 md:py-24 lg:py-32 text-center relative z-10">
					...
					<h3 className="font-display text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-normal mb-4 md:mb-6 leading-tight text-primary-foreground group inline-block">
						<span className="group-hover:text-gold-light transition-colors duration-500">Prête à vous reconnecter à vous-même ?</span>
					</h3>
			...
			<div className="container mx-auto px-5 md:px-8 lg:px-12 py-12 md:py-20 lg:py-24">
				<div className="grid gap-10 md:gap-14 lg:grid-cols-12">
					...
					<div className="lg:col-span-3 relative">
						...
						<div className="hidden lg:block absolute top-0 right-0 w-[2px] h-full bg-gradient-to-b from-transparent via-gold/60 to-transparent shadow-[0_0_8px_hsl(var(--gold)/0.4)]" aria-hidden="true" />

						<div className="relative h-11 md:h-14 w-[132px] md:w-[168px] mb-6 group">
							<div className="absolute inset-0 bg-gold/40 rounded-xl blur-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500" aria-hidden="true" />
							<Image
						...
						<div className="w-20 h-0.5 bg-gradient-to-r from-gold via-gold/60 to-transparent mb-8 shadow-[0_0_8px_hsl(var(--gold)/0.5)]" aria-hidden="true" />
						...
						<div className="flex gap-3">
							{socialLinks.map((link) => (
								...
								>
									<div className="absolute inset-0 bg-gradient-to-br from-gold/20 via-accent/15 to-gold/10 opacity-0 group-hover:opacity-100 transition-opacity duration-500" aria-hidden="true" />
									<div className="absolute inset-0 bg-gold/30 rounded-full blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500" aria-hidden="true" />
								...
								{navLinks.map((link) => (
									<li key={link.href}>
										{link.external ? (
											...
											>
												<span className="w-1.5 h-1.5 rounded-full bg-gold/60 group-hover:bg-gold group-hover:shadow-[0_0_12px_hsl(var(--gold)/0.8)] transition-all duration-300" aria-hidden="true" />
							...
							<ul className="space-y-4 md:space-y-5 mt-4 md:mt-6">
									...
									{!showPhone ? (
										...
										>
											<div className="relative w-8 h-8 md:w-9 md:h-9 rounded-full bg-primary-foreground/10 flex items-center justify-center shrink-0 group-hover:bg-primary-foreground/20 transition-colors duration-300">
												<div className="absolute inset-0 bg-gold/20 rounded-full blur-md opacity-0 group-hover:opacity-60 transition-opacity duration-300" aria-hidden="true" />
												<Phone className="w-4 h-4 text-primary-foreground/70 relative z-10 group-hover:text-primary-foreground group-hover:scale-110 transition-all duration-300" aria-hidden="true" />
											</div>
											<span className="flex items-center gap-1.5 group-hover:translate-x-1.5 transition-transform duration-300">
												<Eye className="w-3 h-3 opacity-60 group-hover:opacity-100" aria-hidden="true" />
												Afficher le numéro
											</span>
										</button>
									) : (
										...
										>
											<div className="relative w-8 h-8 md:w-9 md:h-9 rounded-full bg-primary-foreground/15 flex items-center justify-center shrink-0 group-hover:bg-primary-foreground/25 transition-colors duration-300">
												<div className="absolute inset-0 bg-gold/30 rounded-full blur-md opacity-60 group-hover:opacity-100 transition-opacity duration-300" aria-hidden="true" />
												<Phone className="w-4 h-4 text-primary-foreground relative z-10 group-hover:scale-110 transition-transform duration-300" aria-hidden="true" />
											</div>
											<span className="group-hover:translate-x-1.5 transition-transform duration-300">06 19 15 19 59</span>
										</a>
									)}
								</li>
								{/* EMAIL */}
								<li itemProp="email">
									{!showEmail ? (
										...
										>
											<div className="relative w-8 h-8 md:w-9 md:h-9 rounded-full bg-primary-foreground/10 flex items-center justify-center shrink-0 group-hover:bg-primary-foreground/20 transition-colors duration-300">
												<div className="absolute inset-0 bg-gold/20 rounded-full blur-md opacity-0 group-hover:opacity-60 transition-opacity duration-300" aria-hidden="true" />
												<Mail className="w-4 h-4 text-primary-foreground/70 relative z-10 group-hover:text-primary-foreground group-hover:scale-110 transition-all duration-300" aria-hidden="true" />
											</div>
											<span className="flex items-center gap-1.5 group-hover:translate-x-1.5 transition-transform duration-300">
												<Eye className="w-3 h-3 opacity-60 group-hover:opacity-100" aria-hidden="true" />
												Afficher l'email
										...
										>
											<div className="relative w-8 h-8 md:w-9 md:h-9 rounded-full bg-primary-foreground/15 flex items-center justify-center shrink-0 group-hover:bg-primary-foreground/25 transition-colors duration-300">
												<div className="absolute inset-0 bg-gold/30 rounded-full blur-md opacity-60 group-hover:opacity-100 transition-opacity duration-300" aria-hidden="true" />
												<Mail className="w-4 h-4 text-primary-foreground relative z-10 group-hover:scale-110 transition-transform duration-300" aria-hidden="true" />
											</div>
											<span className="group-hover:translate-x-1.5 transition-transform duration-300">contact@lylusio.fr</span>
										</a>
									)}
								</li>
								{/* ADDRESS */}
								...
								>
									<div className="relative w-8 h-8 md:w-9 md:h-9 rounded-full bg-primary-foreground/10 flex items-center justify-center shrink-0 mt-0.5 group-hover:bg-primary-foreground/20 transition-colors duration-300">
										<div className="absolute inset-0 bg-gold/20 rounded-full blur-md opacity-0 group-hover:opacity-60 transition-opacity duration-300" aria-hidden="true" />
										<MapPin className="w-4 h-4 text-primary-foreground/70 relative z-10 group-hover:text-primary-foreground group-hover:scale-110 transition-all duration-300" aria-hidden="true" />
									</div>
									<a
									...
									>
										<span itemProp="streetAddress">49 route de Labastide</span>,{" "}
										<span itemProp="postalCode">31620</span>{" "}
										<span itemProp="addressLocality">Cépet</span>
										<br />
										<span className="text-primary-foreground/75 text-xs md:text-sm">Toulouse Nord & en ligne</span>
									</a>
								</li>
							</ul>
							<HoneypotContact />
					...
					<div className="lg:col-span-4 mt-8 lg:mt-0">
						...
						<div className="relative group/map rounded-2xl overflow-hidden border border-gold/30 shadow-[0_4px_20px_-4px_hsl(var(--gold)/0.2)] hover:shadow-[0_8px_30px_-4px_hsl(var(--gold)/0.4),0_0_20px_-4px_hsl(var(--accent)/0.2)] transition-all duration-500">
							{/* Golden glow effect */}
							<div className="absolute inset-0 bg-gradient-to-br from-gold/5 via-transparent to-accent/5 opacity-0 group-hover/map:opacity-100 transition-opacity duration-500 pointer-events-none z-10" aria-hidden="true" />
			...
			<div className="relative border-t border-gold/30">
				{/* Golden gradient line - REINFORCED */}
				<div className="absolute top-0 left-1/2 -translate-x-1/2 w-2/5 h-[2px] bg-gradient-to-r from-transparent via-gold/80 to-transparent shadow-[0_0_12px_hsl(var(--gold)/0.6)]" aria-hidden="true" />
				...
				<div className="container mx-auto px-5 md:px-8 lg:px-12 py-7 md:py-9 flex flex-col sm:flex-row justify-between items-center gap-4">
					<p className="text-primary-foreground/80 text-xs md:text-sm flex items-center gap-2.5 tracking-wide">
						<span className="w-1.5 h-1.5 rounded-full bg-gold/70 shadow-[0_0_6px_hsl(var(--gold)/0.6)]" aria-hidden="true" />
					...
					<div className="flex flex-wrap justify-center gap-5 md:gap-7 text-xs md:text-sm">
						...
						>
							<span className="group-hover:translate-x-1 inline-block transition-transform duration-300">Mentions légales</span>
						...
						<Link
							...
							className="text-primary-foreground/80 hover:text-primary-foreground transition-all duration-300 relative group"
						>
							<span className="group-hover:translate-x-1 inline-block transition-transform duration-300">CGU</span>
							<span className="absolute -bottom-0.5 left-0 w-0 h-[2px] bg-gradient-to-r from-gold via-gold-light to-gold group-hover:w-full transition-all duration-400 ease-out shadow-[0_0_12px_hsl(var(--gold)/0.7)]" />
						</Link>
						<Link
							...
							className="text-primary-foreground/80 hover:text-primary-foreground transition-all duration-300 relative group"
						>
							<span className="group-hover:translate-x-1 inline-block transition-transform duration-300">Confidentialité</span>
							<span className="absolute -bottom-0.5 left-0 w-0 h-[2px] bg-gradient-to-r from-gold via-gold-light to-gold group-hover:w-full transition-all duration-400 ease-out shadow-[0_0_12px_hsl(var(--gold)/0.7)]" />
						</Link>
					</div>
				</div>
