	...
	return (
		...
		>
			{stars.map((star) => (
				<div
					key={star.id}
					className="absolute rounded-full bg-gold/90 motion-safe:animate-twinkle will-change-opacity"
					style={{
						left: star.left,
						top: star.top,
						width: `${star.size}px`,
...
// SoftClouds - Nuages flottants avec parallax
		...
		>
			...
			>
				...
				<text
					...
					className="fill-navy/30 dark:fill-gold/20 motion-safe:animate-handwriting"
					style={{
						fontSize: "100px",
...
// DecorativeCircles - Cercles tournants autour de la photo
		...
		>
			...
			<div className="relative z-10 container-wide section-padding grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-center">
				...
				<div className="lg:col-span-7 max-w-2xl mx-auto lg:mx-0 text-center lg:text-left order-2 lg:order-1">
					...
					<div
						className="space-y-4 mb-8 motion-safe:animate-fade-up"
					...
					<div
						className="motion-safe:animate-fade-up flex justify-center lg:justify-start"
						style={{ animationDelay: "0.4s" }}
					>
						<Button
							asChild
							size="lg"
							className="bg-gold text-foreground hover:bg-gold-light font-medium px-8 py-6 shadow-gold transition-all duration-300 hover:scale-105 hover:shadow-glow active:scale-100 motion-safe:animate-gold-glow focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gold focus-visible:ring-offset-2 min-h-[48px]"
				...
				<div
					className="lg:col-span-5 relative order-1 lg:order-2 motion-safe:animate-fade-up pt-4 sm:pt-6 md:pt-8 lg:pt-0"
					style={{
						animationDelay: "0.3s",
				...
				>
					<div className="relative mx-auto max-w-[200px] sm:max-w-[240px]">
						...
						<div
							className="hidden sm:flex absolute -top-2 -right-2 sm:-top-3 sm:-right-3 px-2 py-1 sm:px-3 sm:py-1.5 bg-background/90 backdrop-blur-md rounded-full shadow-soft motion-safe:animate-float border border-gold/25 items-center gap-1.5 hover:scale-105 transition-transform duration-300"
							style={{ animationDelay: "1.2s" }}
							aria-label="Localisation : Toulouse et en ligne"
						>
							<MapPin
			...
			<button
				...
				className="absolute bottom-8 left-1/2 -translate-x-1/2 z-20 flex flex-col items-center gap-2 text-muted-foreground/70 hover:text-accent transition-all duration-300 motion-safe:animate-fade-in group focus:outline-none focus:ring-2 focus:ring-accent/50 rounded-lg p-3 min-h-[48px] min-w-[48px]"
			...
			>
				...
				<ChevronDown
					className="w-5 h-5 motion-safe:animate-bounce group-hover:translate-y-1 transition-transform"
					aria-hidden="true"
				/>
			</button>
		</section>
