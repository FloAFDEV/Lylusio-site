...
const ClickToReveal = ({
	...
	const href =
		type === "phone" ? `tel:${actualValue}` : `mailto:${actualValue}`;
	const revealText =
		type === "phone" ? "Afficher le numéro" : "Afficher l'email";
	const ariaLabel =
		type === "phone"
			? `Appeler le ${display}`
	...
	const baseButtonStyles = {
		default:
			"flex items-center gap-2 text-muted-foreground hover:text-accent transition-all duration-300 cursor-pointer group",
		compact:
			"flex items-center gap-2 text-sm text-muted-foreground hover:text-accent transition-all duration-300 cursor-pointer",
	...
	const baseLinkStyles = {
		default:
			"flex items-center gap-2 text-muted-foreground hover:text-accent transition-all duration-300",
		compact:
			"flex items-center gap-2 text-sm text-muted-foreground hover:text-accent transition-all duration-300",
...
export const HoneypotContact = () => (
	...
	>
		<a href="tel:+33000000000" tabIndex={-1}>
			00 00 00 00 00
		</a>
		<a href="mailto:spam-trap@example.com" tabIndex={-1}>
