...
const faqCategories = [
	{
		...
		questions: [
			...
			{
				question:
					"Ai-je besoin de connaître mon heure de naissance exacte ?",
				answer: "L'heure exacte de naissance est essentielle pour une analyse complète car elle détermine l'Ascendant et les maisons astrologiques. Vous pouvez aussi demander votre acte de naissance complet à la mairie de votre lieu de naissance.",
			},
			{
				question:
					"Quelle est la différence entre astrologie et voyance ?",
	...
	},
	{
		...
		questions: [
			...
			},
			{
				...
				answer: (
					<div className="space-y-2">
						<p>
							La thérapie holistique est particulièrement adaptée
							si vous souffrez de :
						</p>
						<ul className="list-disc pl-5 space-y-1">
							...
							<li>
								Difficulté à lâcher prise sur les événements ou
								les personnes
							</li>
							<li>Troubles du sommeil</li>
							<li>Épuisement, fatigue, manque d'entrain</li>
							<li>
								Manque de confiance en soi, blocages pour
								avancer ou décider
							</li>
							<li>Peurs, phobies</li>
						</ul>
			...
			{
				question:
					"La thérapie holistique remplace-t-elle un suivi médical ?",
			...
			},
			{
				...
				answer: (
					<span>
						Oui, le Reiki fait partie des approches énergétiques
						intégrées. Découvrez-en plus sur la{" "}
						<Link
							href="/reiki-toulouse"
