						...
						<div className="container mx-auto px-4 sm:px-6 lg:px-8">
							...
							>
								...
								<div className="grid md:grid-cols-5 gap-6 md:gap-8 items-start">
									...
									<figure
										className={`md:col-span-2 relative transition-all duration-&lsqb;1.2s&rsqb; ${
											historyInView
									...
									{/* Glass content card */}
									<article
										className={`md:col-span-3 bg-card/70 backdrop-blur-xl rounded-2xl md:rounded-3xl p-5 sm:p-6 md:p-8 lg:p-10 border border-border/30 shadow-xl transition-all duration-1000 delay-200 ${
											historyInView
