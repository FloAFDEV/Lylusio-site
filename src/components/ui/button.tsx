...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full font-medium font-body transition-all duration-300 ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 hover:-translate-y-0.5 active:translate-y-0 active:scale-[0.98]",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground hover:bg-primary/90 shadow-soft hover:shadow-medium text-[15px]",
        ...
        // Soft hero button - gentle blush with subtle glow
        hero: "bg-cta text-cta-foreground font-medium hover:bg-cta-hover shadow-soft hover:shadow-glow text-base",
        // Elegant soft outline variant
        elegant: "border border-accent/30 bg-transparent text-foreground hover:border-accent/50 hover:bg-accent/5 text-[15px]",
        // Glass effect button
        glass: "bg-background/60 backdrop-blur-md border border-border/40 text-foreground hover:bg-background/80 text-[15px]",
      },
      size: {
