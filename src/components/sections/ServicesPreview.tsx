...
const services = [
	{
		...
		calendlyLink: "https://calendly.com/lylusio-fr/themenatal",
	},
	{
		image: seanceReiki,
		icon: Zap,
		...
		format: "Présentiel ou distance",
		href: "/reiki-toulouse",
		calendlyLink: "https://calendly.com/lylusio-fr/soin-energetique-reiki",
	},
	{
		...
		calendlyLink: "https://calendly.com/lylusio-fr/accompagnement-global",
	},
];
									...
									<div className="relative h-36 sm:h-40 md:h-44 lg:h-48 overflow-hidden rounded-t-2xl md:rounded-t-3xl">
										<div className="absolute inset-0 overflow-hidden">
											<img
												src={service.image}
												alt={service.alt}
												className="block w-full h-[calc(100%+8px)] -mt-1 object-cover transition-transform duration-700 ease-out group-hover:scale-105 transform-gpu"
												style={{
													transformOrigin:
														"center center",
													willChange: "transform",
