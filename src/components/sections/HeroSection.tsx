...
import emilieHero from "@/assets/emilie-hero.webp";
...
const HeroSection = () => {
	...
	return (
		<section
			id="accueil"
			className="relative min-h-[100svh] flex items-center overflow-hidden bg-gradient-to-br from-background via-cream/30 to-sand/20"
	...
	"
				...
				<div
					className="lg:col-span-5 relative order-1 lg:order-2 animate-fade-up"
					style={{
						animationDelay: "0.3s",
