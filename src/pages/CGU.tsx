...
const CGU = () => {
	return (
		<>
			<Helmet>
				<title>
					Conditions Générales d'Utilisation | Lylusio - Astrologie &
					Reiki Toulouse
				</title>
				<meta
					name="description"
					content="Conditions générales d'utilisation du site Lylusio. Modalités de réservation, tarifs et conditions des consultations d'astrologie et soins Reiki à Toulouse."
				/>
				<meta name="robots" content="noindex, nofollow" />
				<link rel="canonical" href="https://lylusio.fr/cgu" />
			</Helmet>
