...
const FAQ = () => {
  return (
    <>
      <Helmet>
        <title>FAQ | Questions Fréquentes Astrologie & Reiki – Lylusio</title>
        <meta name="description" content="Retrouvez les réponses à vos questions sur l'astrologie, le Reiki, les tarifs et le déroulement des séances avec Émilie Perez." />
        <link rel="canonical" href="https://lylusio.fr/faq" />
        <meta property="og:title" content="FAQ | Questions Fréquentes Astrologie & Reiki – Lylusio" />
        <meta property="og:description" content="Réponses aux questions fréquentes sur l'astrologie, le Reiki et l'accompagnement holistique." />
        <meta property="og:url" content="https://lylusio.fr/faq" />
        <meta property="og:type" content="website" />
        <meta property="og:image" content="https://lylusio.fr/og-image.jpg" />
