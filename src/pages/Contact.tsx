  ...
  return (
    <div ref={ref} className="grid sm:grid-cols-2 gap-6 mb-12">
      ...
      <ContactCard
        ...
        revealedContent={<p className="text-muted-foreground">06 19 15 19 59</p>}
      ...
      <ContactCard
        ...
        revealedContent={<p className="text-muted-foreground">contact@lylusio.fr</p>}
      ...
      >
        ...
        <div>
          <p className="font-display text-lg text-foreground">Localisation</p>
          <p className="text-muted-foreground">
            49 route de Labastide, 31620 Cépet
            <br />
            <span className="text-sm">(Toulouse Nord) – en présentiel & en ligne</span>
          </p>
          <span className="text-xs text-accent/70 mt-1 inline-block">Ouvrir dans Maps →</span>
        </div>
      </a>
      ...
      >
        ...
        <div>
          <p className="font-display text-lg text-foreground">Rendez-vous</p>
          <p className="text-muted-foreground text-sm">Réserver une séance en ligne</p>
        </div>
      </a>
...
const Contact = () => {
  return (
    <>
      <Helmet>
        <title>Contact | Réservez votre Séance Astrologie & Reiki – Lylusio Toulouse</title>
        <meta
          name="description"
          content="Contactez Émilie Perez pour une consultation en astrologie ou un soin Reiki à Toulouse ou en ligne. Téléphone : 06 19 15 19 59. Email : contact@lylusio.fr"
        />
        <link rel="canonical" href="https://lylusio.fr/contact" />
        <meta property="og:title" content="Contact | Réservez votre Séance – Lylusio Toulouse" />
        <meta
          property="og:description"
          content="Contactez Émilie Perez pour une consultation en astrologie ou un soin Reiki à Toulouse."
        />
        <meta property="og:url" content="https://lylusio.fr/contact" />
        <meta property="og:type" content="website" />
      </Helmet>

      <div className="min-h-screen bg-background animate-fade-in" style={{ animationDuration: '0.6s' }}>
        ...
        <main id="main-content" className="pb-16 md:pb-20">
          <section className="container mx-auto px-4 sm:px-6 lg:px-8" aria-labelledby="contact-title">
            <div className="max-w-3xl mx-auto">
              ...
              <div className="text-center space-y-4">
                ...
                >
                  <a href="https://calendly.com/lylusio-fr" target="_blank" rel="noopener noreferrer">
                    Réserver une séance
                  </a>
                </Button>
