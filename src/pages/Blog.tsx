...
const Blog = () => {
	...
	return (
		<>
			<Helmet>
				<title>
					Blog Astrologie & Bien-être | Articles & Réflexions –
					Lylusio
				</title>
				<meta
					name="description"
					content="Explorations autour de l'astrologie, du Reiki et du développement personnel. Articles et réflexions par Émilie Perez, astrologue et praticienne Reiki."
				/>
				<link rel="canonical" href="https://lylusio.fr/blog" />
				<meta
					property="og:title"
					content="Blog Astrologie & Bien-être | Articles & Réflexions – Lylusio"
				/>
				<meta
					property="og:description"
					content="Articles sur l'astrologie, le Reiki et le développement personnel."
				/>
				<meta property="og:url" content="https://lylusio.fr/blog" />
				...
				<main id="main-content" className="pb-16 md:pb-20 relative">
					...
					>
							...
							<p className="text-muted-foreground text-base sm:text-lg leading-relaxed max-w-2xl mx-auto">
								...
								{totalPosts > 0 && (
									<span className="block mt-2 text-sm text-accent">
										{totalPosts} articles disponibles
									</span>
								)}
							</p>
						</header>
						...
						<div className="max-w-5xl mx-auto mb-8">
							<div className="flex flex-col sm:flex-row gap-4 justify-between items-start sm:items-center p-4 bg-card/50 rounded-xl border border-border/20">
