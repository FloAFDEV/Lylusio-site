...
import travailAstro from "@/assets/travail-astro.webp";
import astroProfondeurs from "@/assets/astro-profondeurs.webp";
import zodiacWheel from "@/assets/zodiac-wheel.webp";

const CALENDLY_THEME_NATAL =
	"https://calendly.com/lylusio-fr/lecture-de-theme-natal";
const CALENDLY_TRANSITS =
	"https://calendly.com/lylusio-fr/lecture-des-transits";
...
const Astrologie = () => {
	...
	return (
		<>
			<SEOHead
				title="Astrologue Toulouse Cépet | Consultation Thème Natal & Transits – Lylusio"
				description="Astrologue à Toulouse et Cépet (31). Consultation thème natal (90€/120€), lecture des transits (60€). Astrologie symbolique et psychologique avec Émilie Perez. En cabinet ou en ligne."
				pathname="/astrologie-toulouse"
				keywords="astrologue toulouse, astrologie cépet, thème natal toulouse, transits astrologie, consultation astrologie"
			/>
			<Helmet>
					...
					>
						...
						>
							<img
								src={zodiacWheel}
								alt=""
								className="w-full h-full object-contain opacity-[0.12] dark:opacity-[0.08]"
								loading="lazy"
							/>
						</div>
						...
						>
							<img
								src={zodiacWheel}
								alt=""
								className="w-full h-full object-contain opacity-[0.20] dark:opacity-[0.06]"
								loading="lazy"
							/>
						</div>
					</div>
							...
							>
								...
								<div className="order-1 text-center lg:text-left">
									...
									<h1 className="text-foreground text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl mb-4 sm:mb-6 leading-tight">
										<span className="font-calligraphic text-accent text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl inline-block align-baseline mr-1">
											C
										</span>
					...
					>
						...
						>
							<div className="grid md:grid-cols-2 gap-8 items-center">
								...
								<article className="card-soft bg-sand/30">
									<div className="flex items-center gap-3 mb-4">
    ...
    opacity-0 group-hover:opacity-100 transition-opacity duration-500"
										...
										<div className="relative">
											<div className="w-20 h-20 lg:w-24 lg:h-24 rounded-[1.5rem] bg-gradient-to-br from-accent/20 to-gold/10 flex items-center justify-center shadow-elegant group-hover:scale-105 group-hover:shadow-[0_8px_30px_-8px_hsl(var(--gold)/0.4)] transition-all duration-500 rotate-3 group-hover:rotate-0">
												<Star className="w-10 h-10 lg:w-12 lg:h-12 text-accent" />
											</div>
										</div>
									</div>
    ...
    opacity-0 group-hover:opacity-100 transition-opacity duration-500"
										...
										<div className="relative">
											<div className="w-20 h-20 lg:w-24 lg:h-24 rounded-[1.5rem] bg-gradient-to-br from-gold/20 to-accent/10 flex items-center justify-center shadow-elegant group-hover:scale-105 group-hover:shadow-[0_8px_30px_-8px_hsl(var(--gold)/0.4)] transition-all duration-500 rotate-3 group-hover:rotate-0">
												<Moon className="w-10 h-10 lg:w-12 lg:h-12 text-gold" />
											</div>
										</div>
									</div>
