...
const Services = () => {
	...
	return (
		<>
			<Helmet>
				<title>
					Services | Astrologie, Reiki & Accompagnement – Lylusio
					Toulouse
				</title>
				<meta
					name="description"
					content="Découvrez les services de Lylusio : consultation astrologique, thérapie énergétique Reiki et accompagnement personnalisé à Toulouse ou en ligne."
				/>
				<link
					rel="canonical"
					href="https://lylusio.fr/therapie-energetique"
				/>
				<meta
					property="og:title"
					content="Services | Astrologie, Reiki & Accompagnement – Lylusio"
				/>
				<meta
					property="og:description"
					content="Astrologie, Reiki et accompagnement personnalisé à Toulouse."
				/>
				<meta
					property="og:url"
					content="https://lylusio.fr/therapie-energetique"
				/>
			...
			<div className="min-h-screen bg-background relative">
				...
				<main
					id="main-content"
					className="pb-16 md:pb-20 relative z-10"
				>
					{/* Hero */}
					<section
						ref={heroRef}
										...
										<div className="relative bg-gradient-to-b from-card/90 to-card/60 backdrop-blur-md rounded-[2rem] overflow-hidden border border-border/20 shadow-soft group-hover:border-gold/40 group-hover:shadow-[0_20px_50px_-15px_hsl(var(--gold)/0.25)] group-hover:-translate-y-3 transition-all duration-500">
											...
											<div className="relative pt-8 pb-4 px-6 flex justify-center">
												<div className="relative">
													<div className="w-24 h-24 lg:w-28 lg:h-28 rounded-[2rem] overflow-hidden border-2 border-gold/25 shadow-elegant transition-all duration-500 rotate-3 group-hover:scale-105 group-hover:border-gold/50 group-hover:shadow-[0_8px_30px_-8px_hsl(var(--gold)/0.4)] group-hover:rotate-0">
														<img
															src={service.image}
															alt={
																service.imageAlt
