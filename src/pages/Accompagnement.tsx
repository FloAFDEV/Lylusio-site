...
import seanceAccompagnement from "@/assets/seance-accompagnement.webp";
import seanceAstro from "@/assets/seance-astro.webp";
import seanceReiki from "@/assets/seance-reiki.webp";
import cascadeZen from "@/assets/cascade-zen.webp";
import tarifThemeNatal from "@/assets/tarif-theme-natal.webp";
import tarifTransits from "@/assets/tarif-transits.webp";
import tarifReiki from "@/assets/tarif-reiki.webp";
import tarifAccompagnement from "@/assets/tarif-accompagnement.webp";
import tarifBilanPro from "@/assets/tarif-bilan-pro.webp";

const CALENDLY_THEME_NATAL = "https://calendly.com/lylusio-fr/themenatal";
const CALENDLY_TRANSITS =
	"https://calendly.com/lylusio-fr/consultation-d-astrologie-energies-de-l-annee";
const CALENDLY_REIKI = "https://calendly.com/lylusio-fr/soin-energetique-reiki";
const CALENDLY_GLOBAL = "https://calendly.com/lylusio-fr/accompagnement-global";
const CALENDLY_BILAN_PRO =
	"https://calendly.com/lylusio-fr/bilan-astro-orientationpro";
...
const Accompagnement = () => {
	...
	return (
		<>
			<SEOHead
				title="Accompagnement & Tarifs Toulouse Cépet | Astrologie, Reiki – Lylusio"
				description="Consultations astrologie (thème natal 90€, transits 70€), soins Reiki (60€) et accompagnement personnalisé à Toulouse et Cépet (31). Réservation en ligne avec Émilie Perez."
				pathname="/accompagnement-toulouse"
				keywords="accompagnement toulouse, tarifs astrologie, tarifs reiki, consultation cépet, thème natal prix"
			/>
			<Helmet>
							...
							>
								...
								<div className="flex justify-center items-center gap-3 sm:gap-4 mb-6 sm:mb-8">
									...
									<div className="relative">
										<div className="w-20 h-20 sm:w-28 sm:h-28 lg:w-32 lg:h-32 rounded-full overflow-hidden shadow-medium border-2 border-gold/30 opacity-90">
											<img
												src={seanceAccompagnement}
