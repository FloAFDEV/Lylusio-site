...
import emilieEnfant from "@/assets/emilie-enfant.webp";
import emilieLumiere from "@/assets/emilie-lumiere.webp";
import emilieAbout from "@/assets/emilie-about.webp";
import arbreLumiere from "@/assets/arbre-lumiere.webp";
...
const About = () => {
	...
	return (
		<>
			<SEOHead
				title="Émilie Perez | Astrologue & Praticienne Reiki Toulouse Cépet – Lylusio"
				description="Découvrez Émilie Perez, astrologue humaniste et praticienne Reiki 3ème degré à Toulouse et Cépet (31). Plus de 10 ans d'expérience dans l'accompagnement des femmes en transition de vie."
				pathname="/emilie-perez"
				ogType="profile"
				keywords="émilie perez, astrologue toulouse, praticienne reiki, thérapeute cépet, accompagnement femmes"
			/>
			<Helmet>
				...
				<main id="main-content" className="pb-16 md:pb-20">
					...
					>
						...
						<img
							...
							alt=""
							aria-hidden="true"
							className="absolute top-0 right-4 md:right-12 w-14 md:w-20 opacity-25 rounded-xl animate-float pointer-events-none"
							style={{
								...
								<figure className="float-none sm:float-left sm:mr-8 sm:mb-4 mb-8 flex justify-center relative">
									...
									>
										...
										<img
											...
											className="relative w-40 sm:w-48 md:w-52 aspect-[3/4] object-cover shadow-medium"
											style={{
												borderRadius:
										...
										<img
											...
											alt=""
											aria-hidden="true"
											className="absolute -bottom-4 -right-4 w-10 md:w-12 opacity-50 rounded-full pointer-events-none"
										/>
									</div>
								</figure>
					...
					>
						...
						<img
							...
							alt=""
							aria-hidden="true"
							className="absolute bottom-8 left-4 md:left-12 w-12 md:w-16 opacity-15 rounded-xl animate-float pointer-events-none transform -rotate-12"
							style={{
						...
						<div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
							<AnimatedSection>
								<div className="flex flex-col lg:flex-row gap-10 lg:gap-16 items-center max-w-5xl mx-auto">
									<figure className="lg:w-5/12 w-full max-w-xs mx-auto lg:max-w-none relative">
										<div className="relative group">
											...
											<img
												...
												className="relative w-full aspect-[3/4] object-cover shadow-medium transition-transform duration-500 group-hover:scale-[1.02]"
												style={{
													borderRadius:
														"50% 50% 45% 55% / 55% 55% 45% 45%",
												}}
										...
										<img
											...
											alt=""
											aria-hidden="true"
											className="absolute -top-3 -left-3 w-10 md:w-12 opacity-40 rounded-full pointer-events-none"
										/>
									</figure>
					...
					>
						...
						<img
							...
							alt=""
							aria-hidden="true"
							className="absolute top-8 right-4 md:right-16 w-10 md:w-14 opacity-20 rounded-lg animate-float pointer-events-none"
							style={{
						...
						<div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
							<AnimatedSection>
								<div className="flex flex-col-reverse lg:flex-row gap-10 lg:gap-16 items-center max-w-5xl mx-auto">
									...
									<figure className="lg:w-5/12 w-full relative group">
										<div className="relative overflow-hidden rounded-2xl md:rounded-3xl shadow-medium">
											...
											<img
												...
												className="relative w-full aspect-[4/3] object-cover rounded-2xl md:rounded-3xl transition-all duration-700 group-hover:scale-[1.02]"
												loading="lazy"
											/>
										...
										<img
											...
											alt=""
											aria-hidden="true"
											className="absolute -bottom-3 -left-3 w-10 md:w-12 opacity-50 rounded-full pointer-events-none"
										/>
									</figure>
								</div>
							</AnimatedSection>
									...
									<figure className="lg:w-5/12 w-full max-w-xs mx-auto lg:max-w-none relative">
										<div className="relative group">
											...
											<img
												...
												className="relative w-full aspect-square object-cover shadow-medium transition-transform duration-500 group-hover:scale-[1.02]"
												style={{
													borderRadius:
														"50% 50% 45% 55% / 55% 55% 45% 45%",
												}}
										...
										<img
											...
											alt=""
											aria-hidden="true"
											className="absolute -bottom-3 -right-3 w-10 md:w-12 opacity-50 rounded-full pointer-events-none"
										/>
									</figure>
					...
					>
						...
						<img
							...
							alt=""
							aria-hidden="true"
							className="absolute bottom-4 right-8 md:right-20 w-12 md:w-16 opacity-15 rounded-full animate-float pointer-events-none"
